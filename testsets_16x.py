...
#         # Load initial frames
#         frame_001 = self.input0_list[0]  # Frame 001
#         frame_019 = self.input1_list[0]  # Frame 019
...
#         self.im_list = ['sequence1']  # List of sequences
        
#         self.input0_list = []
#         self.input1_list = []
        
#         # Specify paths for the frames you have
#         frame0_path = join(db_dir, 'input', 'sequence1', 'frame_001.png')
#         frame1_path = join(db_dir, 'input', 'sequence1', 'frame_019.png')
        
#         # Check if the frame files exist before loading
#         if exists(frame0_path):
#             self.input0_list.append(self.transform(Image.open(frame0_path).convert('RGB')).cuda().unsqueeze(0))
#         else:
#             print(f"Warning: {frame0_path} not found.")

#         if exists(frame1_path):
#             self.input1_list.append(self.transform(Image.open(frame1_path).convert('RGB')).cuda().unsqueeze(0))
#         else:
